...
var Carousel = function (_Component) {
    ...
    _createClass(Carousel, [{
        ...
        value: function render() {
            ...
            var transformProp = (0, _CSSTranslate2.default)(currentPosition + '%', this.props.axis, this.props.rtlEnabled);
...
var _initialiseProps = function _initialiseProps() {
    ...
    this.setPosition = function (position, forceReflow) {
        ...
        ['WebkitTransform', 'MozTransform', 'MsTransform', 'OTransform', 'transform', 'msTransform'].forEach(function (prop) {
            list.style[prop] = (0, _CSSTranslate2.default)(position, _this5.props.axis, _this5.props.rtlEnabled);
        });
        if (forceReflow) {
            list.offsetLeft;
        }
